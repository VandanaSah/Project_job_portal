...
const MyProfile = () => {
  ...
  return (
    <div className="account_components">
      ...
      <div>
        <label className="white" >Email Address</label>
        <input
          type="email"
          disabled
      ...
      {user && user.role === "Job Seeker" && (
        <div>
          <label className="white">My Preferred Job Niches</label>
          <div
      ...
      <div>
        <label className="white">Role</label>
        <input
          type="text"
          disabled
      ...
      <div>
        <label className="white">Joined On</label>
        <input
          type="text"
          disabled
